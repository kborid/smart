...
import com.kborid.smart.network.HostType;
...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = PRJApplication.getInstance().getCacheDir().getAbsolutePath();
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(PRJApplication.getInstance().getResources().getColor(color));
