...
public class ToastUitl {
    ...
    private static Toast initToast(CharSequence message, int duration) {
        if (toast == null) {
            toast = Toast.makeText(PRJApplication.getInstance(), message, duration);
        } else {
    ...
    public static void showShort(int strResId) {
        initToast(PRJApplication.getInstance().getResources().getText(strResId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showLong(int strResId) {
        initToast(PRJApplication.getInstance().getResources().getText(strResId), Toast.LENGTH_LONG).show();
    }
...
//        if (toast2 == null) {
            toast2 = new Toast(PRJApplication.getInstance());
//        }
